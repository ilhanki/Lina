...
- Screenshot diske kaydedilmez, Memory'ye yazılmaz ve modele gönderilmez.
- Sürekli ekran izleme, OCR ve görsel analiz henüz yoktur.
...
- Screenshot diske, modele veya kalıcı hafızaya gönderilmez.
...
- `v0.7.1-alpha`: Vision Provider Architecture hedefi.
...
- TTS yoktur.
- Screen capture yalnız kullanıcı tetiklemeli geçici context olarak vardır; OCR ve Vision yoktur.
...
`v0.7.0-alpha` Screen Context Foundation doğrulamasında tam test paketi:
