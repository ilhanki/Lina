...
- `v0.7.1-alpha`: Local Vision Integration.
- `v0.7.2-alpha`: Vision UX ve Region Capture hedefi.
...
- TTS yoktur.
- Vision yalnız açıkça eklenen tek screenshot ve yerel Ollama modeliyle çalışır; region capture ve sürekli izleme yoktur.
